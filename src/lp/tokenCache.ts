...
export const KNOWN_TOKENS_BY_CHAIN: Partial<Record<ChainId, Record<string, TokenMeta>>> = {
  ...
  avalanche: {
    ...
    '0xa7d7079b0fe9d78f8af2817d23a9d9059f2ea8a9': { symbol: 'USDC.e', decimals: 6 },
    '0x9702230a8ea53601f5cd2dc00fdbc13d4df4a8c7': { symbol: 'USDT', decimals: 6 },
  },
  'hyperliquid-l1': {
    '0x0000000000000000000000000000000000000000': { symbol: 'ETH', decimals: 18 },
    '0x3b0227ed9c03b1e3e70d49af4fbcd0a273299718': { symbol: 'USDC', decimals: 6 },
    '0xe11ca9aa509e53bca5161ba5b12850cd003f0b24': { symbol: 'HYPE', decimals: 18 },
  },
};
